...
Design goals:
  ...
  • Safe for GitHub Actions (fast, ~2-5s for 100s of pages)
  • Skips external links, mailto:, tel:, javascript:, data:, anchors
  • Handles pretty URLs, extensionless URLs, relative links, subpaths
...
def normalize_target(link: str, current_file: Path) -> Path | None:
    """Map a link to a candidate path inside public/. Return None to skip."""
